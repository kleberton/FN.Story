    ...
    public class ProdutosControllerTest
    {
        ...
        public class ProdutoRepositoryFake : IProdutoRepository
        {
            ...
            public IEnumerable<Produto> Get()
            {
                ...
                var tipo2 = new TipoDeProduto { Id = 2, Nome = "Tipo2" };

                return new List<Produto>
                {
                    new Produto{ Id=1,Nome="Produto 1", Preco = 1, Qtde = 10,TipoDeProdutoId=tipo1.Id,TipoDeProduto=tipo1},
                    new Produto{ Id=1,Nome="Produto 2", Preco = 2, Qtde = 20,TipoDeProdutoId=tipo1.Id,TipoDeProduto=tipo1},
                    new Produto{ Id=1,Nome="Produto 3", Preco = 3, Qtde = 30,TipoDeProdutoId=tipo1.Id,TipoDeProduto=tipo1}
                };
            }
